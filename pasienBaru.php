...
<html>
	...
	<body>
                ...
                //RM-001-01012024
                $today = date('dmy');
                $queryNo = mysqli_query($koneksi, "SELECT max(nim) as maxno FROM pasien WHERE right(nim, 6) = '$today'");
			...
			<div class="inner">
				...
				<form action="pages/tambahPasienBaru.php" method="post">
					...
					<div class="form-holder">
						...
						<input type="text" class="form-control" placeholder="NIM" name="nim" id="nim" value="<?= $noRM ?>" readonly>
					</div>
					<button type="submit">
						<span>Daftar</span>
					</button>
