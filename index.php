        ...
        <div class="container position-relative">
          <div class="row align-items-center">
            ...
            <div class="col-md-7 col-lg-6 text-center text-md-start pt-5 pt-md-9">
              ...
              <p class="mt-3 mb-4 fs-1">E-POLINUS provides progressive, and affordable<br class="d-none d-lg-block" />healthcare, accessible on mobile and online<br class="d-none d-lg-block" />for everyone</p><a class="btn btn-lg btn-primary rounded-pill hover-top" href="pilihDokter.php" role="button">Find a doctor</a>
            </div>
          </div>
        </div>
      </section>
